...
const Header: React.FC = () => {
  ...
  return (
    <header className="h-28 bg-[#0a0f1e]/95 backdrop-blur-xl border-b border-blue-900/40 flex items-center justify-between px-12 shadow-2xl relative z-[100] shrink-0">
      ...
      {/* Zentraler Bereich: Großer Banner-Schriftzug */}
      ...
      {/* Rechter Bereich: Personendaten (Oben Rechts dauerhaft) */}
      <div className="flex items-center gap-8">
        ...
        <button 
          ...
          title="Abmelden"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:rotate-12 transition-transform"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
        </button>
      </div>
    </header>
  );
